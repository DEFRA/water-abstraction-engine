...
# Resolve the real script location, following symlinks (handles node_modules/.bin/ symlinks)
...
TEMPLATE_PRESENTER="$SCRIPT_DIR/templates/presenter.js"
TEMPLATE_VIEW_SERVICE="$SCRIPT_DIR/templates/view-service.js"
TEMPLATE_SUBMIT_SERVICE="$SCRIPT_DIR/templates/submit.service.js"
TEMPLATE_VALIDATOR="$SCRIPT_DIR/templates/validator.js"
TEMPLATE_VIEW="$SCRIPT_DIR/templates/view.njk"

TEMPLATE_TEST_PRESENTER="$SCRIPT_DIR/templates/presenter.test.js"
TEMPLATE_TEST_VIEW_SERVICE="$SCRIPT_DIR/templates/view-service.test.js"
TEMPLATE_TEST_SUBMIT_SERVICE="$SCRIPT_DIR/templates/submit.service.test.js"
TEMPLATE_TEST_VALIDATOR="$SCRIPT_DIR/templates/validator.test.js"
...
render_test_file() {
  ...
  sed -e "s#__FETCH_SESSION_DAL_TEST_PATH__#${RELATIVE_UP_PATH}../src/dal/fetch-session.dal.js#g" \
...
generate_helper_snippet() {
  local snippet_template="$SCRIPT_DIR/templates/helper.js"
...
generate_paths() {
  ...
  if [ -n "$REL_DIR" ]; then
    SOURCE_OUTPUT="src/${SUBFOLDER}/${REL_DIR}/${SOURCE_FILE}"
    TEST_OUTPUT="test/${SUBFOLDER}/${REL_DIR}/${TEST_FILE}"
  else
    SOURCE_OUTPUT="src/${SUBFOLDER}/${SOURCE_FILE}"
